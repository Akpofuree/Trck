      ...
      <div className="flex flex-1 flex-col justify-between px-6 py-10 sm:px-12 lg:px-16 min-h-screen">
        ...
        <div className="mx-auto w-full max-w-[560px] text-center">
          ...
          <h1 className="font-[var(--font-playfair)] text-[2.2rem] sm:text-[2.6rem] font-normal leading-[1.25] text-gray-900 tracking-tight mb-3">
            {data ? data.title : "More than events, it's your lifestyle"}
          </h1>

          {/* Subtitle */}
          <p className="text-[0.92rem] sm:text-[1rem] text-gray-500 max-w-[460px] mx-auto leading-relaxed mb-8">
            {data ? data.subtitle : "From concerts to chill spots, from solo adventures to group hangouts — Trck brings experiences to life."}
          </p>

          {/* Main Graphic Illustration */}
          <div className="relative mx-auto my-4 flex justify-center items-center w-full max-w-[440px] h-[190px] sm:h-[230px]">
            <Image
              src={data ? data.graphic : "/onboarding-friends.png"}
              alt="Diverse friends enjoying lifestyle experiences"
              fill
