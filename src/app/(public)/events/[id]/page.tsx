...
const faqs = [
  {
    ...
    a: "Yes, you can attend individual dates depending on availability.",
  },
  {
    q: "What is the cancellation policy?",
    a: "Cancellation policies depend on the organizer and ticket class.",
  },
  {
    q: "Is there parking available?",
    a: "Parking details are shown in the location section.",
  },
  {
    q: "Are recordings available?",
    a: "Some events may offer replays after the live show.",
  },
  {
    q: "Are there age restrictions?",
    a: "Age restrictions are listed per event and enforced at checkout.",
  },
];
    ...
    <footer className="border-t border-white/10 bg-black px-6 py-12 text-white lg:px-16">
      <div className="mx-auto max-w-[1440px]">
        <div className="grid grid-cols-1 gap-10 border-b border-white/10 pb-12 sm:grid-cols-2 md:grid-cols-4">
          <div>
            <h4 className="mb-4 text-[0.78rem] font-bold uppercase tracking-wider">
              Contact
            </h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="md:px-4 md:border-r md:border-[#ED5A2E]/50 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xs text-white/60 mt-1">
                    123 Main St, London, UK 10001
                  </p>
                </div>
                <Link
                  href="#"
                  className="mt-4 flex items-center gap-1 text-xs font-medium text-[#ED5A2E] hover:underline"
                >
          ...
          <div className="mt-12 space-y-12">
            <section className="rounded-[18px] bg-[#111111] p-6 sm:p-8">
              ...
              <p className="mt-4 max-w-[1160px] text-[0.94rem] leading-relaxed text-white/80">
                ...
                Phasellus eu luctus risus. Sed eu pharetra mi, vel suscipit
                nibh. Mauris volutpat, arcu sed consequat pulvinar, dolor ante
                feugiat est, id ultricies arcu urna eu augue. Fusce sed odio
                ipsum. Suspendisse sit amet aliquam nisl. Sed in lacinia massa.
                Nulla maximus varius sem nec tempor. Curabitur quis elit non mi
                eleifend finibus.
              </p>
              <div className="mt-8">
                <SectionRule />
              ...
              <h2 className="mt-8 text-[1.35rem] font-bold uppercase tracking-tight">
                Target audience
              </h2>
              <p className="mt-4 text-[0.94rem] leading-relaxed text-white/80">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </p>
              <div className="mt-8">
                <SectionRule />
              ...
              <div className="mt-6 space-y-6">
                {[
                  [
                    ...
                    "Arrive, check in, and enjoy complimentary beverages",
                  ],
                  [
                    "7:30 PM",
                    "Opening Act",
                    "Local talent showcase featuring emerging afrobeats artists",
                  ],
                  [
                    "8:30 PM",
                    "Main Performance",
                    "Headlining afrobeats ensemble performs classic and contemporary pieces",
                  ],
                  [
                    "10:30 PM",
                    "Networking Session",
                    "Meet fellow afrobeats enthusiasts and the performers",
                  ],
                  ...
                  <div key={time} className="grid grid-cols-[44px_1fr] gap-4">
                    ...
                    <div className="pb-2">
                      <div className="text-[0.72rem] font-medium text-[#ED5A2E]">
                        {time}
                      </div>
                      <div className="mt-1 text-[1rem] font-semibold">
                        {title}
                      </div>
            ...
            <section className="rounded-[18px] bg-[#111111] p-6 sm:p-8">
              ...
              <div className="mt-6 space-y-6">
                {reviews.map((item) => (
                  <div
                    key={item.id}
                    className="grid gap-4 lg:grid-cols-[60px_1fr_120px] items-start border-b border-white/5 pb-6"
                  >
                    ...
                    <div className="text-[#FFD400] lg:text-right">
                      <Stars />
                    </div>
                  </div>
                ))}
      ...
      <section className="lg:hidden">
        ...
        <div className="relative -mt-6 rounded-t-[24px] bg-black px-4 pt-5 pb-8 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4 pt-2">
            <div>
              <div className="text-xs font-bold uppercase text-white underline decoration-[#ED5A2E] decoration-2 underline-offset-8">
                Ticket Type
              </div>
            ...
            <div className="rounded-xl bg-[#111111] p-4 space-y-4">
              {[
                ...
                [
                  "8:30 PM",
                  "Main Performance",
                  "Headlining afrobeats ensemble performs classic pieces",
                ],
                [
                  "10:30 PM",
                  "Networking Session",
                ...
                <div key={time} className="flex gap-3 text-xs">
                  <div className="text-[#ED5A2E] font-semibold w-16 shrink-0">
                    {time}
                  </div>
                  <div>
