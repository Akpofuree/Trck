      ...
      <div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-5">
          ...
          <div className="flex items-center gap-3 flex-1 max-w-2xl">
            ...
            <button className="bg-[#FF6536] hover:bg-[#e0552b] text-white px-5 py-2.5 rounded-xl text-sm font-semibold flex items-center gap-2 shrink-0 transition-colors shadow-sm">
